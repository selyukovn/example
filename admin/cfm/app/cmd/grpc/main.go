...
import (
	...
	opera_use_cases_confirm "example/admin/cfm/internal/opera/use_cases/confirm"
	opera_use_cases_create_for_email "example/admin/cfm/internal/opera/use_cases/create_for_email"
	opera_use_cases_request "example/admin/cfm/internal/opera/use_cases/request"
	"flag"
	"fmt"

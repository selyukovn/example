...
type SignInRequestRetry = func(context.Context, openapi.PutAuthSignInRequestRetryRequestObject) (openapi.PutAuthSignInRequestRetryResponseObject, error)

// ---------------------------------------------------------------------------------------------------------------------

func NewSignInRequestRetry(sec security.Security, sAuth auth.ClientInterface) SignInRequestRetry {
	return func(ctx context.Context, r openapi.PutAuthSignInRequestRetryRequestObject) (openapi.PutAuthSignInRequestRetryResponseObject, error) {
		...
		res, err := sAuth.SignInRequestRetry(ctx, user.Ip(), user.UserAgent(), signInId)

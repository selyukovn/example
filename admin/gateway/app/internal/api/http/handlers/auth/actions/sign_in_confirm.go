...
type SignInConfirm = func(context.Context, openapi.PutAuthSignInConfirmRequestObject) (openapi.PutAuthSignInConfirmResponseObject, error)

// ---------------------------------------------------------------------------------------------------------------------

func NewSignInConfirm(sec security.Security, sAuth auth.ClientInterface) SignInConfirm {
	return func(ctx context.Context, r openapi.PutAuthSignInConfirmRequestObject) (openapi.PutAuthSignInConfirmResponseObject, error) {
		...
		res, err := sAuth.SignInConfirm(ctx, user.Ip(), user.UserAgent(), signInId, code)

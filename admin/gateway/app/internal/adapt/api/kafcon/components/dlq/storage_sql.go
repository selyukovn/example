...
var _ dlq.StorageInterface = StorageSQL{}
...
func (s StorageSQL) GetMessages(
	...
	rChan := make(chan dlq.GetMessagesItem)
...
func getMessagesMakeItemError(err error) dlq.GetMessagesItem {
	return dlq.GetMessagesItem{
		KMsg: nil,
		Err:  err,
	}
}

func getMessagesMakeItemMsg(kMsg *kafka.Message) dlq.GetMessagesItem {
	return dlq.GetMessagesItem{
		KMsg: kMsg,
		Err:  nil,
	}

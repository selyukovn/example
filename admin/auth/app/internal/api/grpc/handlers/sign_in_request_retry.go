...
func NewSignInRequestRetry(ucSignInRequestRetry sign_in_request_retry.Command) func(ctx context.Context, req *pb.SignInRequestRetryRequest) (*pb.SignInRequestRetryResponse, error) {
